...
var require_get = __commonJS({
  "node_modules/lodash/get.js"(exports, module) {
    var baseGet2 = require_baseGet();
    function get15(object, path, defaultValue) {
...
var require_createSet = __commonJS({
  "node_modules/lodash/_createSet.js"(exports, module) {
    var Set2 = require_Set();
    var noop13 = require_noop();
    var setToArray = require_setToArray();
    var INFINITY = 1 / 0;
    var createSet = !(Set2 && 1 / setToArray(new Set2([, -0]))[1] == INFINITY) ? noop13 : function(values) {
...
var require_baseMatchesProperty = __commonJS({
  "node_modules/lodash/_baseMatchesProperty.js"(exports, module) {
    ...
    function baseMatchesProperty(path, srcValue) {
      ...
      return function(object) {
        var objValue = get15(object, path);
  ...
  return {
    onFetch: (context, query) => {
      ...
      if (context.options.persister) {
        context.fetchFn = () => {
          var _a11, _b;
          return (_b = (_a11 = context.options).persister) == null ? void 0 : _b.call(
            _a11,
            fetchFn,
            {
              queryKey: context.queryKey,
...
function getPreviousPageParam(options, { pages, pageParams }) {
  var _a11;
  return (_a11 = options.getPreviousPageParam) == null ? void 0 : _a11.call(
    options,
    pages[0],
    pages,
    pageParams[0],
...
var _client2, _currentResult2, _currentMutation, _mutateOptions, _updateResult, updateResult_fn, _notify2, notify_fn2, _a10;
...
var StoreContextProvider = function(_a11) {
  ...
  return React11.createElement(StoreContext.Provider, { value: Store }, children);
};
...
var StoreSetter = function(_a11) {
  ...
  return React12.createElement(React12.Fragment, null, children);
};
...
var NotificationContextProvider = function(_a11) {
  ...
  return React13.createElement(
    ...
    { value: contextValue },
    React13.createElement(AddNotificationContext.Provider, { value: addNotification }, children)
  );
};
...
var I18nContextProvider = function(_a11) {
  ...
  return isInitialized ? React14.createElement(I18nContext.Provider, { value, key }, children) : null;
};
...
var TestTranslationProvider = function(_a11) {
  ...
  return React15.createElement(I18nContextProvider, { value: testI18nProvider({ translate, messages }) }, children);
};
...
var TranslatableContextProvider = function(_a11) {
  ...
  return React16.createElement(TranslatableContext.Provider, { value }, children);
};
...
var AdminRouter = function(_a11) {
  ...
  return React18.createElement(
    ...
    React18.createElement(Router, { basename }, children)
  );
};
...
var InternalRouter = function(_a11) {
  var children = _a11.children, basename = _a11.basename;
  var router = createHashRouter([{ path: "*", element: React18.createElement(React18.Fragment, null, children) }], {
    basename
  });
  return React18.createElement(RouterProvider, { router });
};
...
var RestoreScrollPosition = function(_a11) {
  var children = _a11.children, storeKey = _a11.storeKey, _b = _a11.debounce, debounce4 = _b === void 0 ? 250 : _b;
...
var useCreatePath = function() {
  ...
  return (0, import_react25.useCallback)(function(_a11) {
...
var useRedirect = function() {
  ...
  return (0, import_react26.useCallback)(function(redirectTo, resource, id, data, state) {
    if (resource === void 0) {
      resource = "";
    }
    if (state === void 0) {
    ...
    if (!redirectTo) {
      ...
      var absoluteTarget = typeof target === "string" ? "".concat(basename, "/").concat(target) : __assign({ pathname: "".concat(basename, "/").concat(target.pathname) }, target);
      ...
      navigate(createPath({ resource, id, type: redirectTo }), {
        state: (
          ...
          redirectTo === "list" ? state : __assign({ _scrollToTop: true }, state)
        )
      });
      return;
    }
...
var useResetErrorBoundaryOnLocationChange = function(resetErrorBoundary) {
  ...
  var originalPathname = (0, import_react27.useRef)(pathname);
...
var TestMemoryRouter = function(_a11) {
  var children = _a11.children, locationCallback = _a11.locationCallback, navigateCallback = _a11.navigateCallback, rest = __rest2(_a11, ["children", "locationCallback", "navigateCallback"]);
  var router = createMemoryRouter([
    {
      path: "*",
      element: React19.createElement(
        React19.Fragment,
        null,
        children,
        locationCallback && React19.createElement(UseLocation, { locationCallback }),
        navigateCallback && React19.createElement(UseNavigate, { navigateCallback })
      )
    }
  ], __assign2({}, rest));
  return React19.createElement(RouterProvider, { router });
};
...
var defaultDataProvider = {
  create: function() {
    return __awaiter(void 0, void 0, void 0, function() {
      return __generator(this, function(_a11) {
...
var fetchJson = function(url, options) {
  ...
  return fetch(url, __assign3(__assign3({}, options), { headers: requestHeaders })).then(function(response) {
...
var testDataProvider = function(overrides) {
  return __assign4(__assign4({}, defaultDataProvider), overrides);
};
...
var withLifecycleCallbacks = function(dataProvider, handlers) {
  return __assign5(__assign5({}, dataProvider), { getList: function(resource, params) {
    ...
    return __awaiter2(this, void 0, void 0, function() {
      ...
      return __generator2(this, function(_a11) {
        switch (_a11.label) {
          case 0:
            newParams = params;
            return [4, applyCallbacks({
...
var useLoading = function() {
  ...
  var _a11 = import_react33.default.useState(isFetchingRef.current || isMutatingRef.current), isLoading = _a11[0], setIsLoading = _a11[1];
...
var useGetOne = function(resource, _a11, options) {
  ...
  var _b = options.onError, onError = _b === void 0 ? noop3 : _b, _c = options.onSuccess, onSuccess = _c === void 0 ? noop3 : _c, _d = options.onSettled, onSettled = _d === void 0 ? noop3 : _d, queryOptions2 = __rest3(options, ["onError", "onSuccess", "onSettled"]);
  var onSuccessEvent = useEvent(onSuccess);
  var onErrorEvent = useEvent(onError);
  var onSettledEvent = useEvent(onSettled);
  var result = useQuery(__assign6({
...
var useGetList = function(resource, params, options) {
  ...
  var dataProvider = useDataProvider();
  var queryClient = useQueryClient();
  var _d = options.onError, onError = _d === void 0 ? noop4 : _d, _e = options.onSuccess, onSuccess = _e === void 0 ? noop4 : _e, _f = options.onSettled, onSettled = _f === void 0 ? noop4 : _f, queryOptions2 = __rest4(options, ["onError", "onSuccess", "onSettled"]);
  var onSuccessEvent = useEvent(onSuccess);
  var onErrorEvent = useEvent(onError);
  var onSettledEvent = useEvent(onSettled);
  var result = useQuery(__assign7({ queryKey: [resource, "getList", { pagination, sort, filter, meta }], queryFn: function(queryParams) {
    return dataProvider.getList(resource, {
      ...
      var data = _a12.data, total = _a12.total, pageInfo = _a12.pageInfo;
      return {
        data,
        total,
        pageInfo
  ...
  return (0, import_react36.useMemo)(function() {
    var _a12, _b2, _c2;
    return result.data ? __assign7(__assign7({}, result), { data: (_a12 = result.data) === null || _a12 === void 0 ? void 0 : _a12.data, total: (_b2 = result.data) === null || _b2 === void 0 ? void 0 : _b2.total, pageInfo: (_c2 = result.data) === null || _c2 === void 0 ? void 0 : _c2.pageInfo }) : result;
  }, [result]);
};
var noop4 = function() {
  return void 0;
...
var useGetMany = function(resource, params, options) {
  ...
  var _a11 = options.onError, onError = _a11 === void 0 ? noop5 : _a11, _b = options.onSuccess, onSuccess = _b === void 0 ? noop5 : _b, _c = options.onSettled, onSettled = _c === void 0 ? noop5 : _c, queryOptions2 = __rest5(options, ["onError", "onSuccess", "onSettled"]);
  var onSuccessEvent = useEvent(onSuccess);
  var onErrorEvent = useEvent(onError);
  var onSettledEvent = useEvent(onSettled);
  var result = useQuery(__assign8({ queryKey: [
    resource,
    "getMany",
    {
    ...
    var records = !ids || ids.length === 0 ? [] : ids.map(function(id) {
      ...
      return (_b2 = (_a12 = queryCache.get(queryHash)) === null || _a12 === void 0 ? void 0 : _a12.state) === null || _b2 === void 0 ? void 0 : _b2.data;
    });
...
var useGetManyAggregate = function(resource, params, options) {
  ...
  var queryClient = useQueryClient();
  var queryCache = queryClient.getQueryCache();
  var _a11 = options.onError, onError = _a11 === void 0 ? noop6 : _a11, _b = options.onSuccess, onSuccess = _b === void 0 ? noop6 : _b, _c = options.onSettled, onSettled = _c === void 0 ? noop6 : _c, queryOptions2 = __rest6(options, ["onError", "onSuccess", "onSettled"]);
  var onSuccessEvent = useEvent(onSuccess);
  var onErrorEvent = useEvent(onError);
  var onSettledEvent = useEvent(onSettled);
  var ids = params.ids, meta = params.meta;
  ...
  var result = useQuery(__assign9({ queryKey: [
    resource,
    "getMany",
    {
  ...
  }, placeholderData, retry: false }, queryOptions2));
...
var useGetManyReference = function(resource, params, options) {
  ...
  var dataProvider = useDataProvider();
  var queryClient = useQueryClient();
  var _d = options.onError, onError = _d === void 0 ? noop7 : _d, _e = options.onSuccess, onSuccess = _e === void 0 ? noop7 : _e, _f = options.onSettled, onSettled = _f === void 0 ? noop7 : _f, queryOptions2 = __rest7(options, ["onError", "onSuccess", "onSettled"]);
  var onSuccessEvent = useEvent(onSuccess);
  var onErrorEvent = useEvent(onError);
  var onSettledEvent = useEvent(onSettled);
  ...
  return (0, import_react39.useMemo)(function() {
    var _a12, _b2, _c2;
    return result.data ? __assign10(__assign10({}, result), { data: (_a12 = result.data) === null || _a12 === void 0 ? void 0 : _a12.data, total: (_b2 = result.data) === null || _b2 === void 0 ? void 0 : _b2.total, pageInfo: (_c2 = result.data) === null || _c2 === void 0 ? void 0 : _c2.pageInfo }) : result;
  }, [result]);
};
var noop7 = function() {
  return void 0;
...
var useFilterState_default = function(_a11) {
  ...
  var permanentFilterProp = (0, import_react40.useRef)(permanentFilter);
  var latestValue = (0, import_react40.useRef)();
  var _e = useSafeSetState(__assign11(__assign11({}, permanentFilter), filterToQuery(""))), filter = _e[0], setFilterValue = _e[1];
  ...
  (0, import_react40.useEffect)(function() {
    if (!(0, import_isEqual.default)(permanentFilterProp.current, permanentFilter)) {
      ...
      setFilterValue(__assign11(__assign11({}, permanentFilter), filterToQuery(latestValue.current || "")));
    }
  }, [permanentFilterSignature, permanentFilterProp, filterToQuery]);
  var setFilter = (0, import_react40.useCallback)(
    (0, import_debounce2.default)(function(value) {
      setFilterValue(__assign11(__assign11({}, permanentFilter), filterToQuery(value)));
...
var removeEmpty = function(object) {
  return Object.keys(object).reduce(function(acc, key) {
    ...
    return isEmpty(child) ? acc : __assign12(__assign12({}, acc), (_a11 = {}, _a11[key] = child, _a11));
  }, {});
};
  ...
  switch (action.type) {
    case SET_SORT:
      if (action.payload.field === previousState.sort) {
        return __assign13(__assign13({}, previousState), { order: oppositeOrder(previousState.order), page: 1 });
      }
      return __assign13(__assign13({}, previousState), { sort: action.payload.field, order: action.payload.order || SORT_ASC, page: 1 });
    case SET_PAGE:
      return __assign13(__assign13({}, previousState), { page: action.payload });
    case SET_PER_PAGE:
      return __assign13(__assign13({}, previousState), { page: 1, perPage: action.payload });
    case SET_FILTER: {
      return __assign13(__assign13({}, previousState), { page: 1, filter: action.payload.filter, displayedFilters: action.payload.displayedFilters ? action.payload.displayedFilters : previousState.displayedFilters });
    }
    case SHOW_FILTER: {
      if (previousState.displayedFilters && previousState.displayedFilters[action.payload.filterName]) {
        return previousState;
      }
      return __assign13(__assign13({}, previousState), {
        ...
        displayedFilters: __assign13(__assign13({}, previousState.displayedFilters), (_a11 = {}, _a11[action.payload.filterName] = true, _a11))
      });
    }
    case HIDE_FILTER: {
      return __assign13(__assign13({}, previousState), {
        ...
        displayedFilters: previousState.displayedFilters ? Object.keys(previousState.displayedFilters).reduce(function(filters, filter) {
          var _a12;
          return filter !== action.payload ? __assign13(__assign13({}, filters), (_a12 = {}, _a12[filter] = true, _a12)) : filters;
...
var useSortState = function(initialSort) {
  ...
  var _a11 = (0, import_react41.useReducer)(sortReducer, initialSort), sort = _a11[0], dispatch = _a11[1];
  var isFirstRender = (0, import_react41.useRef)(true);
  ...
  return {
    setSort: (0, import_react41.useCallback)(function(sort2) {
      return dispatch({ type: "SET_SORT", payload: sort2 });
    }, [dispatch]),
    setSortField: (0, import_react41.useCallback)(function(field) {
      return dispatch({ type: "SET_SORT_FIELD", payload: field });
    }, [dispatch]),
    setSortOrder: (0, import_react41.useCallback)(function(order) {
...
var paginationReducer = function(prevState, nextState) {
  return __assign14(__assign14({}, prevState), nextState);
};
...
var usePaginationState_default = function(initialPagination) {
  ...
  var _a11 = (0, import_react42.useReducer)(paginationReducer, __assign14(__assign14({}, defaultPagination), initialPagination)), pagination = _a11[0], setPagination = _a11[1];
  var isFirstRender = (0, import_react42.useRef)(true);
  var setPerPage = (0, import_react42.useCallback)(function(perPage) {
    return setPagination({ perPage, page: 1 });
  }, []);
  var setPage = (0, import_react42.useCallback)(function(page) {
...
var useDeleteWithUndoController = function(props) {
  var record = props.record, _a11 = props.redirect, redirectTo = _a11 === void 0 ? "list" : _a11, onClick = props.onClick, _b = props.mutationOptions, mutationOptions = _b === void 0 ? {} : _b;
  var mutationMeta = mutationOptions.meta, otherMutationOptions = __rest8(mutationOptions, ["meta"]);
  ...
  var handleDelete = (0, import_react43.useCallback)(function(event) {
    ...
    deleteOne(resource, {
      ...
      previousData: record,
      meta: mutationMeta
    }, __assign15({ mutationMode: "undoable" }, otherMutationOptions));
...
var useDeleteWithConfirmController = function(props) {
  var record = props.record, _a11 = props.redirect, redirectTo = _a11 === void 0 ? "list" : _a11, mutationMode = props.mutationMode, onClick = props.onClick, _b = props.mutationOptions, mutationOptions = _b === void 0 ? {} : _b;
  var mutationMeta = mutationOptions.meta, otherMutationOptions = __rest9(mutationOptions, ["meta"]);
  var resource = useResourceContext(props);
  var _c = (0, import_react44.useState)(false), open = _c[0], setOpen = _c[1];
  var notify = useNotify();
  var unselect = useUnselect(resource);
  var redirect = useRedirect();
  ...
  var handleDelete = (0, import_react44.useCallback)(function(event) {
    event.stopPropagation();
    if (!record) {
      throw new Error("The record cannot be deleted because no record has been passed");
    }
    deleteOne(resource, {
      ...
      previousData: record,
      meta: mutationMeta
    }, __assign16({ mutationMode }, otherMutationOptions));
    if (typeof onClick === "function") {
      onClick(event);
    }
  }, [
...
var SaveContext = (0, import_react45.createContext)({});
...
var usePickSaveContext = function(context) {
  var value = (0, import_react46.useMemo)(
    function() {
...
var useSaveContext = function(_props) {
  return (0, import_react47.useContext)(SaveContext);
};
...
var useMutationMiddlewares = function() {
  var callbacks = (0, import_react48.useRef)([]);
  var registerMutationMiddleware = (0, import_react48.useCallback)(function(callback) {
    callbacks.current.push(callback);
  }, []);
  var unregisterMutationMiddleware = (0, import_react48.useCallback)(function(callback) {
    callbacks.current = callbacks.current.filter(function(cb) {
      return cb !== callback;
    });
  }, []);
  var getMutateWithMiddlewares = (0, import_react48.useCallback)(function(fn) {
    var currentCallbacks = __spreadArray8([], callbacks.current, true);
    return function() {
      var args = [];
      for (var _i = 0; _i < arguments.length; _i++) {
        args[_i] = arguments[_i];
      ...
      var next = function() {
        ...
        index--;
        if (index >= 0) {
          return currentCallbacks[index].apply(currentCallbacks, __spreadArray8(__spreadArray8([], newArgs, false), [next], false));
        } else {
          return fn.apply(void 0, newArgs);
        }
      };
      if (currentCallbacks.length > 0) {
        return currentCallbacks[index].apply(currentCallbacks, __spreadArray8(__spreadArray8([], args, false), [next], false));
      }
      return fn.apply(void 0, args);
    };
  }, []);
  var functions = (0, import_react48.useMemo)(function() {
    return {
      registerMutationMiddleware,
...
var useCreateController = function(props) {
  ...
  var notify = useNotify();
  var redirect = useRedirect();
  var recordToUse = (_a11 = record !== null && record !== void 0 ? record : getRecordFromLocation(location)) !== null && _a11 !== void 0 ? _a11 : void 0;
  var onSuccess = mutationOptions.onSuccess, onError = mutationOptions.onError, meta = mutationOptions.meta, otherMutationOptions = __rest10(mutationOptions, ["onSuccess", "onError", "meta"]);
  ...
  var _e = useCreate(resource, void 0, __assign17(__assign17({ onSuccess: function(data, variables, context) {
  ...
  var save = (0, import_react50.useCallback)(function(data, _a12) {
    if (_a12 === void 0) {
      _a12 = {};
    }
    var transformFromSave = _a12.transform, metaFromSave = _a12.meta, callTimeOptions = __rest10(_a12, ["transform", "meta"]);
...
var getRecordFromLocation = function(_a11) {
...
var RecordContext = (0, import_react51.createContext)(void 0);
...
var CreateContext = (0, import_react52.createContext)(null);
...
var CreateContextProvider = function(_a11) {
  ...
  return React24.createElement(
    ...
    React24.createElement(
      SaveContextProvider,
      { value: __assign18(__assign18({}, usePickSaveContext(value)), { mutationMode: "pessimistic" }) },
...
var CreateBase = function(_a11) {
  var children = _a11.children, props = __rest11(_a11, ["children"]);
...
var CreateController = function(_a11) {
  var children = _a11.children, props = __rest12(_a11, ["children"]);
  var controllerProps = useCreateController(props);
...
var useCreateContext = function() {
  var context = (0, import_react53.useContext)(CreateContext);
  if (!context) {
...
var useEditController = function(props) {
  ...
  var disableAuthentication = props.disableAuthentication, propsId = props.id, _a11 = props.mutationMode, mutationMode = _a11 === void 0 ? "undoable" : _a11, _b = props.mutationOptions, mutationOptions = _b === void 0 ? {} : _b, _c = props.queryOptions, queryOptions2 = _c === void 0 ? {} : _c, _d = props.redirect, redirectTo = _d === void 0 ? DefaultRedirect : _d, transform2 = props.transform;
  useAuthenticated({ enabled: !disableAuthentication });
  var resource = useResourceContext(props);
  if (!resource) {
  ...
  var queryMeta = queryOptions2.meta, otherQueryOptions = __rest13(queryOptions2, ["meta"]);
  var mutationMeta = mutationOptions.meta, onSuccess = mutationOptions.onSuccess, onError = mutationOptions.onError, otherMutationOptions = __rest13(mutationOptions, ["meta", "onSuccess", "onError"]);
  ...
  var _f = useGetOne(resource, { id, meta: queryMeta }, __assign19({ onError: function() {
  ...
  var _g = useUpdate(resource, recordCached, __assign19(__assign19({ onSuccess: function(data, variables, context) {
  ...
  var save = (0, import_react54.useCallback)(function(data, _a12) {
    ...
    return Promise.resolve(transformFromSave ? transformFromSave(data, {
      ...
      return __awaiter5(void 0, void 0, void 0, function() {
        var error_1;
        var _a13;
        return __generator5(this, function(_b3) {
          switch (_b3.label) {
            case 0:
              _b3.trys.push([0, 2, , 3]);
...
var useRecordContext = function(props) {
  var context = (0, import_react55.useContext)(RecordContext);
...
var EditContext = (0, import_react56.createContext)(null);
...
var EditBase = function(_a11) {
  var children = _a11.children, props = __rest14(_a11, ["children"]);
...
var EditController = function(_a11) {
  var children = _a11.children, props = __rest15(_a11, ["children"]);
  var controllerProps = useEditController(props);
  return children(controllerProps);
};
...
var useEditContext = function() {
  var context = (0, import_react57.useContext)(EditContext);
  if (!context) {
...
var ReferenceFieldContext = (0, import_react58.createContext)(null);
var ReferenceFieldContextProvider = ReferenceFieldContext.Provider;
var useReferenceFieldContext = function() {
  var context = (0, import_react58.useContext)(ReferenceFieldContext);
  if (!context) {
...
var useReference = function(_a11) {
  ...
  var meta = options.meta, otherQueryOptions = __rest16(options, ["meta"]);
...
var useReferenceFieldController = function(options) {
  var _a11 = options.link, link = _a11 === void 0 ? "edit" : _a11, reference = options.reference, queryOptions2 = options.queryOptions;
  if (!reference) {
  ...
  var referenceRecordQuery = useReference({
    reference,
    id,
    options: __assign20(__assign20({}, queryOptions2), { enabled: ((queryOptions2 === null || queryOptions2 === void 0 ? void 0 : queryOptions2.enabled) == null || (queryOptions2 === null || queryOptions2 === void 0 ? void 0 : queryOptions2.enabled) === true) && id != null })
  });
  var createPath = useCreatePath();
  var resourceDefinition = useResourceDefinition({ resource: reference });
  var result = (0, import_react59.useMemo)(function() {
    return __assign20(__assign20({}, referenceRecordQuery), { link: referenceRecordQuery.referenceRecord != null ? link === false || link === "edit" && !resourceDefinition.hasEdit || link === "show" && !resourceDefinition.hasShow ? false : createPath({
      resource: reference,
...
var ReferenceFieldBase = function(props) {
  ...
  return React31.createElement(
    ...
    React31.createElement(
      ...
      React31.createElement(RecordContextProvider, { value: controllerProps.referenceRecord }, children)
    )
  );
};
...
var ExporterContext = (0, import_react60.createContext)(defaultExporter_default);
...
var useRecordSelection = function(args) {
  ...
  var _c = (0, import_react61.useState)(defaultSelection), localIds = _c[0], setLocalIds = _c[1];
  ...
  var selectionModifiers = (0, import_react61.useMemo)(function() {
    return {
      select: function(idsToAdd) {
        if (!idsToAdd)
          return;
        setIds(__spreadArray9([], idsToAdd, true));
      },
      ...
      toggle: function(id) {
        ...
        setIds(function(ids2) {
          if (!Array.isArray(ids2))
            return __spreadArray9([], ids2, true);
          var index = ids2.indexOf(id);
          return index > -1 ? __spreadArray9(__spreadArray9([], ids2.slice(0, index), true), ids2.slice(index + 1), true) : __spreadArray9(__spreadArray9([], ids2, true), [id], false);
        });
      },
...
function useSafeSetState(initialState2) {
  var _a11 = (0, import_react62.useState)(initialState2), state = _a11[0], setState = _a11[1];
  var mountedRef = (0, import_react62.useRef)(false);
  ...
  var safeSetState = (0, import_react62.useCallback)(function(args) {
    if (mountedRef.current) {
...
function usePrevious(value) {
  var ref = (0, import_react62.useRef)();
  (0, import_react62.useEffect)(function() {
    ref.current = value;
  });
  return ref.current;
...
function useDeepCompareEffect(callback, inputs) {
  var cleanupRef = (0, import_react62.useRef)();
  (0, import_react62.useEffect)(function() {
...
function useTimeout(ms, key) {
  ...
  var _a11 = useSafeSetState(false), ready = _a11[0], setReady = _a11[1];
  (0, import_react62.useEffect)(function() {
    setReady(false);
...
function useIsMounted() {
  var isMounted = (0, import_react62.useRef)(true);
  (0, import_react62.useEffect)(function() {
...
var useListParams = function(_a11) {
  var _b = _a11.debounce, debounce4 = _b === void 0 ? 500 : _b, _c = _a11.disableSyncWithLocation, disableSyncWithLocation = _c === void 0 ? false : _c, filterDefaultValues = _a11.filterDefaultValues, _d = _a11.perPage, perPage = _d === void 0 ? 10 : _d, resource = _a11.resource, _e = _a11.sort, sort = _e === void 0 ? defaultSort2 : _e, _f = _a11.storeKey, storeKey = _f === void 0 ? "".concat(resource, ".listParams") : _f;
  var location = useLocation();
  var navigate = useNavigate();
  var _g = (0, import_react63.useState)(defaultParams), localParams = _g[0], setLocalParams = _g[1];
  var _h = useStore(storeKey || "".concat(resource, ".listParams"), defaultParams), params = _h[0], setParams = _h[1];
  var tempParams = (0, import_react63.useRef)();
  ...
  var query = (0, import_react63.useMemo)(
    function() {
      return getQuery({
        queryFromLocation,
  ...
  var changeParams = (0, import_react63.useCallback)(function(action) {
    ...
    if (!tempParams.current) {
      ...
      setTimeout(function() {
        ...
        if (disableSyncWithLocation) {
          ...
          navigate({
            search: "?".concat((0, import_query_string3.stringify)(__assign21(__assign21({}, tempParams.current), { filter: JSON.stringify(tempParams.current.filter), displayedFilters: JSON.stringify(tempParams.current.displayedFilters) })))
          }, {
            state: {
  ...
  }, __spreadArray10(__spreadArray10([], requestSignature, true), [navigate], false));
  var setSort = (0, import_react63.useCallback)(function(sort2) {
    return changeParams({
      type: SET_SORT,
      payload: sort2
    });
  }, [changeParams]);
  var setPage = (0, import_react63.useCallback)(function(newPage) {
    return changeParams({ type: SET_PAGE, payload: newPage });
  }, [changeParams]);
  var setPerPage = (0, import_react63.useCallback)(function(newPerPage) {
  ...
  var setFilters = (0, import_react63.useCallback)(
  ...
  var hideFilter = (0, import_react63.useCallback)(function(filterName) {
    changeParams({
      type: HIDE_FILTER,
      payload: filterName
    });
  }, [changeParams]);
  var showFilter = (0, import_react63.useCallback)(function(filterName, defaultValue) {
    changeParams({
      type: SHOW_FILTER,
      payload: {
        filterName,
  ...
  return [
    __assign21(__assign21({ filterValues, requestSignature }, query), { displayedFilters: displayedFilterValues }),
    {
      changeParams,
      setPage,
      setPerPage,
...
var getQuery = function(_a11) {
  ...
  var query = Object.keys(queryFromLocation).length > 0 ? queryFromLocation : hasCustomParams(params) ? __assign21({}, params) : { filter: filterDefaultValues || {} };
  if (!query.sort) {
  ...
  return __assign21(__assign21({}, query), { page: getNumberOrDefault(query.page, 1), perPage: getNumberOrDefault(query.perPage, 10) });
};
...
var useInfiniteListController = function(props) {
  ...
  var _a11 = props.debounce, debounce4 = _a11 === void 0 ? 500 : _a11, disableAuthentication = props.disableAuthentication, disableSyncWithLocation = props.disableSyncWithLocation, _b = props.exporter, exporter = _b === void 0 ? defaultExporter_default : _b, filter = props.filter, filterDefaultValues = props.filterDefaultValues, _c = props.perPage, perPage = _c === void 0 ? 10 : _c, queryOptions2 = props.queryOptions, sort = props.sort, storeKey = props.storeKey;
  useAuthenticated({ enabled: !disableAuthentication });
  var resource = useResourceContext(props);
  var _d = queryOptions2 !== null && queryOptions2 !== void 0 ? queryOptions2 : {}, meta = _d.meta, otherQueryOptions = __rest17(_d, ["meta"]);
  if (!resource) {
  ...
  if (filter && (0, import_react64.isValidElement)(filter)) {
  ...
  var _g = useInfiniteGetList(resource, {
    ...
    filter: __assign22(__assign22({}, query.filter), filter),
    meta
  }, __assign22({ placeholderData: function(previousData) {
    return previousData;
  ...
  var currentSort = (0, import_react64.useMemo)(function() {
    return {
      field: query.sort,
      order: query.order
    };
  ...
  var unwrappedData = (0, import_react64.useMemo)(function() {
    var _a12;
    return (_a12 = data === null || data === void 0 ? void 0 : data.pages) === null || _a12 === void 0 ? void 0 : _a12.reduce(function(acc, page) {
      return __spreadArray11(__spreadArray11([], acc, true), page.data, true);
    }, []);
  }, [data]);
  return {
    sort: currentSort,
...
var ListSortContext = (0, import_react67.createContext)(void 0);
...
var ListPaginationContext = (0, import_react68.createContext)(void 0);
  ...
  return React32.createElement(
    ...
    React32.createElement(
      ...
      React32.createElement(
        ...
        React32.createElement(ListPaginationContext.Provider, { value: usePickPaginationContext(value) }, children)
      )
    )
  );
};
...
var InfinitePaginationContext = (0, import_react69.createContext)({
  hasNextPage: false,
...
var InfiniteListBase = function(_a11) {
  var children = _a11.children, props = __rest18(_a11, ["children"]);
  ...
  return React33.createElement(
    ...
    React33.createElement(
      ListContextProvider,
      { value: controllerProps },
      React33.createElement(InfinitePaginationContext.Provider, { value: {
...
var useListController = function(props) {
  ...
  var _a11 = props.debounce, debounce4 = _a11 === void 0 ? 500 : _a11, disableAuthentication = props.disableAuthentication, disableSyncWithLocation = props.disableSyncWithLocation, _b = props.exporter, exporter = _b === void 0 ? defaultExporter_default : _b, filter = props.filter, filterDefaultValues = props.filterDefaultValues, _c = props.perPage, perPage = _c === void 0 ? 10 : _c, _d = props.queryOptions, queryOptions2 = _d === void 0 ? {} : _d, _e = props.sort, sort = _e === void 0 ? defaultSort3 : _e, storeKey = props.storeKey;
  useAuthenticated({ enabled: !disableAuthentication });
  var resource = useResourceContext(props);
  var meta = queryOptions2.meta, otherQueryOptions = __rest19(queryOptions2, ["meta"]);
  if (!resource) {
  ...
  var _h = useGetList(resource, {
    ...
    sort: { field: query.sort, order: query.order },
    filter: __assign23(__assign23({}, query.filter), filter),
    meta
  }, __assign23({ placeholderData: function(previousData) {
    return previousData;
  }, retry: false, onError: function(error2) {
    return notify((error2 === null || error2 === void 0 ? void 0 : error2.message) || "ra.notification.http_error", {
      type: "error",
  ...
  var currentSort = (0, import_react70.useMemo)(function() {
    return {
      field: query.sort,
      order: query.order
    };
...
var getListControllerProps = function(props) {
  return injectedProps.reduce(function(acc, key) {
    var _a11;
    return __assign23(__assign23({}, acc), (_a11 = {}, _a11[key] = props[key], _a11));
  }, {});
};
...
var ListBase = function(_a11) {
  var children = _a11.children, props = __rest20(_a11, ["children"]);
  return React34.createElement(
    ResourceContextProvider,
    { value: props.resource },
    React34.createElement(ListContextProvider, { value: useListController(props) }, children)
  );
};
...
var useExpanded = function(resource, id, single) {
  ...
  var toggleExpanded = (0, import_react71.useCallback)(function() {
    setExpandedIds(function(ids) {
      ...
      return index > -1 ? single ? [] : __spreadArray12(__spreadArray12([], ids.slice(0, index), true), ids.slice(index + 1), true) : single ? [id] : __spreadArray12(__spreadArray12([], ids, true), [id], false);
    });
...
var useExpandAll = function(resource, ids) {
  ...
  var toggleExpandedAll = (0, import_react71.useCallback)(function() {
...
var useInfinitePaginationContext = function() {
  return (0, import_react72.useContext)(InfinitePaginationContext);
};
...
var useList = function(props) {
  ...
  var filterRef = (0, import_react73.useRef)(filter);
  ...
  var hideFilter = (0, import_react73.useCallback)(function(filterName) {
    setDisplayedFilters(function(previousState) {
      var _a12 = previousState, _b2 = filterName, _ = _a12[_b2], newState = __rest22(_a12, [typeof _b2 === "symbol" ? _b2 : _b2 + ""]);
      return newState;
    });
  ...
  var showFilter = (0, import_react73.useCallback)(function(filterName, defaultValue) {
    setDisplayedFilters(function(previousState) {
      var _a12;
      return __assign24(__assign24({}, previousState), (_a12 = {}, _a12[filterName] = true, _a12));
    });
    setFilterValues(function(previousState) {
      var _a12;
      return removeEmpty_default(__assign24(__assign24({}, previousState), (_a12 = {}, _a12[filterName] = defaultValue, _a12)));
    });
  }, [setDisplayedFilters, setFilterValues]);
  var setFilters = (0, import_react73.useCallback)(function(filters, displayedFilters2) {
...
var useListContext = function() {
  var context = (0, import_react74.useContext)(ListContext);
  if (!context) {
...
var useListContextWithProps = function(props) {
  var context = (0, import_react75.useContext)(ListContext);
...
var useListFilterContext = function() {
  var context = (0, import_react76.useContext)(ListFilterContext);
  if (!context) {
...
var useListPaginationContext = function() {
  var context = (0, import_react77.useContext)(ListPaginationContext);
  if (!context) {
...
var useListSortContext = function() {
  var context = (0, import_react78.useContext)(ListSortContext);
  if (!context) {
...
var useUnselect = function(resource) {
  ...
  return (0, import_react79.useCallback)(function(ids) {
    unselect(ids);
  }, [unselect]);
};
...
var useReferenceArrayFieldController = function(props) {
  ...
  var meta = queryOptions2.meta, otherQueryOptions = __rest23(queryOptions2, ["meta"]);
  var ids = Array.isArray(value) ? value : emptyArray;
  var _e = useGetManyAggregate(reference, { ids, meta }, __assign25({ onError: function(error2) {
  ...
  return __assign25(__assign25({}, listProps), { defaultTitle: void 0, refetch: refetch2, resource: reference });
};
...
var useReferenceManyFieldController = function(props) {
  var _a11 = props.debounce, debounce4 = _a11 === void 0 ? 500 : _a11, reference = props.reference, record = props.record, target = props.target, _b = props.filter, filter = _b === void 0 ? defaultFilter4 : _b, _c = props.source, source = _c === void 0 ? "id" : _c, initialPage = props.page, initialPerPage = props.perPage, _d = props.sort, initialSort = _d === void 0 ? { field: "id", order: "DESC" } : _d, _e = props.queryOptions, queryOptions2 = _e === void 0 ? {} : _e;
  var notify = useNotify();
  var resource = useResourceContext(props);
  var meta = queryOptions2.meta, otherQueryOptions = __rest24(queryOptions2, ["meta"]);
  ...
  var setSort = (0, import_react81.useCallback)(function(sort2) {
    setSortState(sort2);
    setPage(1);
  }, [setPage, setSortState]);
  ...
  var filterRef = (0, import_react81.useRef)(filter);
  ...
  var hideFilter = (0, import_react81.useCallback)(function(filterName) {
    setDisplayedFilters(function(previousState) {
      var _a12 = previousState, _b2 = filterName, _ = _a12[_b2], newState = __rest24(_a12, [typeof _b2 === "symbol" ? _b2 : _b2 + ""]);
      return newState;
    });
    setFilterValues(function(previousState) {
      var _a12 = previousState, _b2 = filterName, _ = _a12[_b2], newState = __rest24(_a12, [typeof _b2 === "symbol" ? _b2 : _b2 + ""]);
  ...
  var showFilter = (0, import_react81.useCallback)(function(filterName, defaultValue) {
    setDisplayedFilters(function(previousState) {
      var _a12;
      return __assign26(__assign26({}, previousState), (_a12 = {}, _a12[filterName] = true, _a12));
    });
    setFilterValues(function(previousState) {
      var _a12;
      return __assign26(__assign26({}, previousState), (_a12 = {}, _a12[filterName] = defaultValue, _a12));
    });
  }, [setDisplayedFilters, setFilterValues]);
  var debouncedSetFilters = (0, import_react81.useCallback)((0, import_debounce4.default)(function(filters, displayedFilters2) {
    setFilterValues(removeEmpty_default(filters));
    setDisplayedFilters(displayedFilters2);
    setPage(1);
  }, debounce4), [setDisplayedFilters, setFilterValues, setPage]);
  var setFilters = (0, import_react81.useCallback)(function(filters, displayedFilters2, debounce5) {
    if (debounce5 === void 0) {
      debounce5 = false;
    }
    if (debounce5) {
  ...
  var _l = useGetManyReference(reference, {
    ...
    filter: filterValues,
    meta
  }, __assign26({ enabled: (0, import_get6.default)(record, source) != null, placeholderData: function(previousData) {
    return previousData;
...
var useReferenceOneFieldController = function(props) {
  ...
  var notify = useNotify();
  var meta = queryOptions2.meta, otherQueryOptions = __rest25(queryOptions2, ["meta"]);
  var _e = useGetManyReference(reference, {
    ...
    filter,
    meta
  }, __assign27({ enabled: !!record, onError: function(error2) {
    return notify(typeof error2 === "string" ? error2 : error2.message || "ra.notification.http_error", {
      type: "error",
      messageArgs: {
        _: typeof error2 === "string" ? error2 : error2 && error2.message ? error2.message : void 0
...
var HookFormContext = import_react82.default.createContext(null);
var useFormContext = () => import_react82.default.useContext(HookFormContext);
var FormProvider = (props) => {
  const { children, ...data } = props;
  return import_react82.default.createElement(HookFormContext.Provider, { value: data }, children);
};
...
function useSubscribe(props) {
  const _props = import_react82.default.useRef(props);
...
function useFormState(props) {
  ...
  const [formState, updateFormState] = import_react82.default.useState(control._formState);
  const _mounted = import_react82.default.useRef(true);
  const _localProxyFormState = import_react82.default.useRef({
    isDirty: false,
    isLoading: false,
    dirtyFields: false,
    touchedFields: false,
  ...
  const _name = import_react82.default.useRef(name);
  _name.current = name;
  useSubscribe({
    disabled,
...
function useWatch(props) {
  ...
  const [value, updateValue] = import_react82.default.useState(control._getWatch(name, defaultValue));
  import_react82.default.useEffect(() => control._removeUnmounted());
  return value;
}
function useController(props) {
  ...
  const _registerProps = import_react82.default.useRef(control.register(name, {
    ...props.rules,
    value,
  ...
  import_react82.default.useEffect(() => {
    ...
    const updateMounted = (name2, value2) => {
      const field = get7(control._fields, name2);
      if (field && field._f) {
  ...
  import_react82.default.useEffect(() => {
    if (get7(control._fields, name)) {
      control._updateDisabledField({
        disabled,
        fields: control._fields,
        name,
        value: get7(control._fields, name)._f.value
      });
    }
  ...
  return {
    field: {
      ...
      onChange: import_react82.default.useCallback((event) => _registerProps.current.onChange({
        target: {
      ...
      onBlur: import_react82.default.useCallback(() => _registerProps.current.onBlur({
        target: {
...
var updateFieldArrayRootError = (errors, error, name) => {
  const fieldArrayErrors = compact(get7(errors, name));
...
function useFieldArray(props) {
  ...
  const [fields, setFields] = import_react82.default.useState(control._getFieldArray(name));
  const ids = import_react82.default.useRef(control._getFieldArray(name).map(generateId));
  const _fieldIds = import_react82.default.useRef(fields);
  const _name = import_react82.default.useRef(name);
  const _actioned = import_react82.default.useRef(false);
  _name.current = name;
  ...
  const updateValues = import_react82.default.useCallback((updatedFieldArrayValues) => {
  ...
  return {
    swap: import_react82.default.useCallback(swap, [updateValues, name, control]),
    move: import_react82.default.useCallback(move, [updateValues, name, control]),
    prepend: import_react82.default.useCallback(prepend, [updateValues, name, control]),
    append: import_react82.default.useCallback(append, [updateValues, name, control]),
    remove: import_react82.default.useCallback(remove, [updateValues, name, control]),
    insert: import_react82.default.useCallback(insert$1, [updateValues, name, control]),
    update: import_react82.default.useCallback(update, [updateValues, name, control]),
    replace: import_react82.default.useCallback(replace, [updateValues, name, control]),
    fields: import_react82.default.useMemo(() => fields.map((field, index) => ({
      ...field,
...
function createFormControl(props = {}) {
  ...
  const shouldRenderByError = (name, isValid2, error, fieldState) => {
    ...
    if (props.delayError && error) {
      delayErrorCallback = debounce4(() => updateErrors(name, error));
  ...
  const _getDirty = (name, data) => (name && data && set4(_formValues, name, data), !deepEqual(getValues2(), _defaultValues));
  const _getWatch = (names, defaultValue, isGlobal) => generateWatchOutput(names, _names, {
    ..._state.mount ? _formValues : isUndefined(defaultValue) ? _defaultValues : isString(names) ? { [names]: defaultValue } : defaultValue
  }, isGlobal, defaultValue);
  const _getFieldArray = (name) => compact(get7(_state.mount ? _formValues : _defaultValues, name, props.shouldUnregister ? get7(_defaultValues, name, []) : []));
  ...
  const onChange = async (event) => {
    ...
    const _updateIsFieldValueUpdated = (fieldValue) => {
      isFieldValueUpdated = Number.isNaN(fieldValue) || fieldValue === get7(_formValues, name, fieldValue);
    };
    if (field) {
      let error;
      let isValid2;
  ...
  const _updateDisabledField = ({ disabled, name, field, fields, value }) => {
    if (isBoolean(disabled) && _state.mount || !!disabled) {
      const inputValue = disabled ? void 0 : isUndefined(value) ? getFieldValue(field ? field._f : get7(fields, name)._f) : value;
      set4(_formValues, name, inputValue);
...
function useForm(props = {}) {
  const _formControl = import_react82.default.useRef();
  const _values = import_react82.default.useRef();
  const [formState, updateFormState] = import_react82.default.useState({
    isDirty: false,
    isValidating: false,
  ...
  import_react82.default.useEffect(() => control._disableForm(props.disabled), [control, props.disabled]);
  import_react82.default.useEffect(() => {
...
var useReferenceParams = function(_a11) {
  var resource = _a11.resource, filter = _a11.filter, _b = _a11.sort, sort = _b === void 0 ? defaultSort4 : _b, _c = _a11.page, page = _c === void 0 ? 1 : _c, _d = _a11.perPage, perPage = _d === void 0 ? 10 : _d, _e = _a11.debounce, debounce4 = _e === void 0 ? 500 : _e;
  var _f = (0, import_react83.useState)(defaultParams2), params = _f[0], setParams = _f[1];
  var tempParams = (0, import_react83.useRef)();
  var requestSignature = [
    resource,
  ...
  var query = (0, import_react83.useMemo)(
    function() {
      return getQuery2({
        params,
  ...
  var changeParams = (0, import_react83.useCallback)(function(action) {
    if (!tempParams.current) {
  ...
  var setSort = (0, import_react83.useCallback)(
    function(sort2) {
      return changeParams({
        type: SET_SORT,
        payload: sort2
  ...
  var setPage = (0, import_react83.useCallback)(
    function(newPage) {
      return changeParams({ type: SET_PAGE, payload: newPage });
    },
    requestSignature
  ...
  var setPerPage = (0, import_react83.useCallback)(
    function(newPerPage) {
      return changeParams({ type: SET_PER_PAGE, payload: newPerPage });
    },
    requestSignature
  ...
  var debouncedSetFilters = (0, import_react83.useRef)((0, import_debounce5.default)(function(filter2, displayedFilters) {
    if (displayedFilters === void 0) {
      displayedFilters = void 0;
    }
    changeParams({
  ...
  var setFilters = (0, import_react83.useCallback)(
...
var getQuery2 = function(_a11) {
  ...
  var query = hasCustomParams2(params) ? __assign28({}, params) : { filter: filterDefaultValues || {} };
  if (!query.sort) {
    query.sort = sort.field;
    query.order = sort.order;
  }
  ...
  return __assign28(__assign28({}, query), { page: getNumberOrDefault2(query.page, 1), perPage: getNumberOrDefault2(query.perPage, 10) });
};
...
var useReferenceArrayInputController = function(props) {
  ...
  var meta = queryOptions2.meta, otherQueryOptions = __rest26(queryOptions2, ["meta"]);
  ...
  var _h = useGetList(reference, {
    ...
    filter: __assign29(__assign29({}, params.filter), filter),
    meta
  }, __assign29({ retry: false, enabled: isGetMatchingEnabled, placeholderData: function(previousData) {
    return previousData;
  ...
  var refetch2 = (0, import_react84.useCallback)(function() {
    refetchGetMany();
    refetchGetMatching();
  }, [refetchGetMany, refetchGetMatching]);
  var currentSort = (0, import_react84.useMemo)(function() {
    return {
      field: params.sort,
      order: params.order
    };
...
var mergeReferences = function(ref1, ref2) {
  var res = __spreadArray13([], ref1, true);
...
var useReferenceInputController = function(props) {
  ...
  var meta = queryOptions2.meta, otherQueryOptions = __rest27(queryOptions2, ["meta"]);
  ...
  var _e = useGetList(reference, {
    ...
    sort: { field: params.sort, order: params.order },
    filter: __assign30(__assign30({}, params.filter), filter),
    meta
  }, __assign30({ enabled: isGetMatchingEnabled, placeholderData: function(previousData) {
    return previousData;
  ...
  var _g = useReference({
    ...
    options: __assign30({ enabled: currentValue != null && currentValue !== "", meta }, otherQueryOptions)
  ...
  var _h = (0, import_react85.useState)(void 0), referenceRecord = _h[0], setReferenceRecord = _h[1];
  ...
  if (!referenceRecord || possibleValuesData.find(function(record) {
    ...
    finalData = __spreadArray14([referenceRecord], possibleValuesData, true);
    finalTotal = total == null ? void 0 : total + 1;
  }
  var refetch2 = (0, import_react85.useCallback)(function() {
    refetchGetList();
    refetchReference();
  }, [refetchGetList, refetchReference]);
  var currentSort = (0, import_react85.useMemo)(function() {
    return {
      field: params.sort,
      order: params.order
    };
...
var useFormValues = function() {
  var getValues2 = useFormContext().getValues;
  return __assign31(__assign31({}, useWatch()), getValues2());
};
...
var FormDataConsumer = function(props) {
  ...
  return React36.createElement(FormDataConsumerView, __assign32({ formData }, props));
};
...
var FormGroupsContext = (0, import_react86.createContext)(void 0);
...
var ValidationError = function(props) {
  ...
  if (errorMessage.message) {
    ...
    return React37.createElement(React37.Fragment, null, translate(message2, __assign33({ _: message2 }, args)));
  }
  return React37.createElement(React37.Fragment, null, translate(errorMessage, { _: errorMessage }));
};
...
var getSimpleValidationResolver = function(validate) {
  return function(data) {
    return __awaiter6(void 0, void 0, void 0, function() {
      ...
      return __generator6(this, function(_a11) {
        switch (_a11.label) {
          case 0:
...
var transformErrorFields = function(error) {
  return Object.keys(error).reduce(function(acc, field) {
    ...
    if (Array.isArray(error[field])) {
      ...
      return __assign34(__assign34({}, acc), (_a11 = {}, _a11[field] = transformedArrayErrors, _a11));
    }
    if (isEmptyObject2(error[field])) {
      return acc;
    }
    if (typeof error[field] === "object" && !isRaTranslationObj(error[field])) {
      return __assign34(__assign34({}, acc), (_b = {}, _b[field] = transformErrorFields(error[field]), _b));
    }
    return __assign34(__assign34({}, acc), (_c = {}, _c[field] = addTypeAndMessage(error[field]), _c));
  }, {});
};
...
var ChoicesContext = (0, import_react87.createContext)(void 0);

// node_modules/ra-core/dist/esm/form/choices/ChoicesContextProvider.js
var React38 = __toESM(require_react());
var ChoicesContextProvider = function(_a11) {
  var children = _a11.children, value = _a11.value;
  return React38.createElement(ChoicesContext.Provider, { value }, children);
};
...
var useChoicesContext = function(options) {
  ...
  var context = (0, import_react88.useContext)(ChoicesContext);
  var _d = useList({
    ...
    perPage: Infinity
  }), data = _d.data, list = __rest28(_d, ["data"]);
  var result = (0, import_react88.useMemo)(function() {
...
var FormGroupsProvider = function(_a11) {
  var children = _a11.children;
  var formGroups = (0, import_react89.useRef)({});
  var subscribers = (0, import_react89.useRef)({});
  var formContextValue = (0, import_react89.useMemo)(function() {
    return {
      /**
      ...
      registerField: function(source, group) {
        if (group != null) {
          if (!(formGroups.current[group] || []).includes(source)) {
            formGroups.current[group] = __spreadArray15(__spreadArray15([], formGroups.current[group] || [], true), [
              source
            ], false);
            if (subscribers.current[group]) {
...
var useWarnWhenUnsavedChanges = function(enable, formRootPathname, control) {
  ...
  var _b = (0, import_react90.useState)(false), shouldNotify = _b[0], setShouldNotify = _b[1];
...
var useNotifyIsFormInvalid = function(control, enabled) {
  ...
  var submitCountRef = (0, import_react91.useRef)(submitCount);
  var notify = useNotify();
...
var useAugmentedForm = function(props) {
  ...
  var form = useForm(__assign35({ criteriaMode, values: defaultValuesIncludingRecord, reValidateMode, resolver: finalResolver }, rest));
  var formRef = (0, import_react92.useRef)(form);
  useNotifyIsFormInvalid(form.control, !disableInvalidFormNotification);
  var handleSubmit = (0, import_react92.useCallback)(function(values, event) {
  ...
  var formHandleSubmit = (0, import_react92.useCallback)(function(event) {
...
function Form(props) {
  ...
  var dataRouterContext = (0, import_react93.useContext)(DataRouterContext);
  var dataRouterStateContext = (0, import_react93.useContext)(DataRouterStateContext);
...
var FormGroupContext = (0, import_react94.createContext)(null);
...
var useFormGroups = function() {
  var context = (0, import_react95.useContext)(FormGroupsContext);
  return context;
};
...
var FormGroupContextProvider = function(_a11) {
  ...
  return React41.createElement(FormGroupContext.Provider, { value: name }, children);
};
...
var useChoices = function(_a11) {
  ...
  var translate = useTranslate();
  var getChoiceText = (0, import_react98.useCallback)(function(choice) {
    if ((0, import_react98.isValidElement)(optionText)) {
      return React42.createElement(RecordContextProvider, { value: choice }, optionText);
    }
    var choiceName = typeof optionText === "function" ? optionText(choice) : (0, import_get10.default)(choice, optionText);
    return (0, import_react98.isValidElement)(choiceName) ? choiceName : translateChoice ? translate(String(choiceName), { _: choiceName }) : String(choiceName);
  }, [optionText, translate, translateChoice]);
  var getChoiceValue = (0, import_react98.useCallback)(function(choice) {
    return (0, import_get10.default)(choice, optionValue);
  }, [optionValue]);
  var getDisableValue = (0, import_react98.useCallback)(function(choice) {
...
var useFormGroup = function(name) {
  ...
  var formGroups = useFormGroups();
  var _b = (0, import_react99.useState)({
    errors: void 0,
    isDirty: false,
    isTouched: false,
    isValid: true,
...
var useFormGroupContext = function() {
  var context = (0, import_react100.useContext)(FormGroupContext);
  return context;
};
...
var useGetValidationErrorMessage = function() {
  ...
  return function(error) {
    if (error.message != null) {
      ...
      return translate(message2, __assign37({ _: message2 }, args));
    }
...
var useInput = function(props) {
  ...
  var defaultId = (0, import_react101.useId)();
  ...
  var _c = useController(__assign38(__assign38({ name: finalName, defaultValue: (0, import_get12.default)(record, finalSource, defaultValue), rules: {
  ...
  var field = __assign38(__assign38({}, controllerField), { value: format2 ? format2(controllerField.value) : controllerField.value, onBlur, onChange });
  return {
    id: id || defaultId,
    field,
    fieldState,
...
var useSuggestions = function(_a11) {
  ...
  var getSuggestions = (0, import_react102.useCallback)(getSuggestionsFactory({
    allowCreate,
    choices: choices2,
    createText,
...
var defaultMatchSuggestion = function(getChoiceText) {
  return function(filter, suggestion, exact) {
    ...
    var isReactElement = (0, import_react102.isValidElement)(suggestionText);
  ...
  return function(filter) {
    ...
    if (selectedItem && !Array.isArray(selectedItem) && matchSuggestion(filter, selectedItem)) {
      if (limitChoicesToValue) {
        ...
        suggestions = __spreadArray16([], choices2, true);
      }
    } else {
      suggestions = choices2.filter(function(choice) {
...
var useUnique = function(options) {
  ...
  var translate = useTranslate();
  var record = useRecordContext();
  var debouncedGetList = (0, import_react103.useRef)(
  ...
  var validateUnique = (0, import_react103.useCallback)(function(callTimeOptions) {
    var _a12 = (0, import_merge3.default)({
...
var ReferenceInputBase = function(props) {
  ...
  var controllerProps = useReferenceInputController(__assign39(__assign39({}, props), { sort, filter }));
  return import_react104.default.createElement(
    ResourceContextProvider,
    { value: reference },
    import_react104.default.createElement(ChoicesContextProvider, { value: controllerProps }, children)
  );
};
...
var useShowController = function(props) {
  ...
  var disableAuthentication = props.disableAuthentication, propsId = props.id, _a11 = props.queryOptions, queryOptions2 = _a11 === void 0 ? {} : _a11;
  useAuthenticated({ enabled: !disableAuthentication });
  var resource = useResourceContext(props);
  if (!resource) {
  ...
  var meta = queryOptions2.meta, otherQueryOptions = __rest31(queryOptions2, ["meta"]);
  var _b = useGetOne(resource, { id, meta }, __assign40({ onError: function() {
    notify("ra.notification.item_doesnt_exist", {
      type: "error"
    });
    redirect("list", resource);
...
var ShowContext = (0, import_react105.createContext)(null);
...
var ShowContextProvider = function(_a11) {
  ...
  return React44.createElement(
    ...
    { value },
    React44.createElement(RecordContextProvider, { value: value && value.record }, children)
  );
};
...
var ShowBase = function(_a11) {
  var children = _a11.children, props = __rest32(_a11, ["children"]);
  var controllerProps = useShowController(props);
  var body = React45.createElement(ShowContextProvider, { value: controllerProps }, children);
  return props.resource ? (
    // support resource override via props
    React45.createElement(ResourceContextProvider, { value: props.resource }, body)
  ) : body;
};
...
var ShowController = function(_a11) {
  var children = _a11.children, props = __rest33(_a11, ["children"]);
  var controllerProps = useShowController(props);
  return children(controllerProps);
};
...
var useShowContext = function() {
  var context = (0, import_react106.useContext)(ShowContext);
  if (!context) {
...
var usePrevNextController = function(props) {
  ...
  var filter = __assign41(__assign41({}, storedParams.filter), permanentFilter);
  ...
  var queryData = queryClient.getQueryData([
    resource,
    "getList",
    __assign41(__assign41({}, params), { pagination: {
  ...
  var _j = useQuery(__assign41({ queryKey: [resource, "getList", params], queryFn: function(queryParams) {
    return dataProvider.getList(resource, __assign41(__assign41({}, params), { signal: dataProvider.supportAbortSignal === true ? queryParams.signal : void 0 }));
...
var useCreate = function(resource, params, options) {
  ...
  var dataProvider = useDataProvider();
  var queryClient = useQueryClient();
  var paramsRef = (0, import_react107.useRef)(params);
  var hasCallTimeOnError = (0, import_react107.useRef)(false);
  var hasCallTimeOnSuccess = (0, import_react107.useRef)(false);
  var hasCallTimeOnSettled = (0, import_react107.useRef)(false);
  var getMutateWithMiddlewares = options.getMutateWithMiddlewares, mutationOptions = __rest35(options, ["getMutateWithMiddlewares"]);
  var mutation = useMutation(__assign42(__assign42({ mutationFn: function(_a11) {
  ...
  var create = function(callTimeResource, callTimeParams, callTimeOptions) {
    ...
    var _a11 = callTimeOptions.returnPromise, returnPromise = _a11 === void 0 ? options.returnPromise : _a11, otherCallTimeOptions = __rest35(callTimeOptions, ["returnPromise"]);
    ...
    if (returnPromise) {
      return mutation.mutateAsync(__assign42({ resource: callTimeResource }, callTimeParams), otherCallTimeOptions);
    }
    return mutation.mutate(__assign42({ resource: callTimeResource }, callTimeParams), otherCallTimeOptions);
  };
  var mutationResult = (0, import_react107.useMemo)(function() {
    return __assign42({ isLoading: mutation.isPending }, mutation);
  }, [mutation]);
...
var useUpdate = function(resource, params, options) {
  ...
  var _a11 = options.mutationMode, mutationMode = _a11 === void 0 ? "pessimistic" : _a11, getMutateWithMiddlewares = options.getMutateWithMiddlewares, mutationOptions = __rest36(options, ["mutationMode", "getMutateWithMiddlewares"]);
  var mode = (0, import_react108.useRef)(mutationMode);
  var paramsRef = (0, import_react108.useRef)(params);
  var snapshot = (0, import_react108.useRef)([]);
  var mutateWithMiddlewares = (0, import_react108.useRef)(dataProvider.update);
  var callTimeOnError = (0, import_react108.useRef)();
  var callTimeOnSettled = (0, import_react108.useRef)();
  var hasCallTimeOnSuccess = (0, import_react108.useRef)(false);
  var updateCache = function(_a12) {
    var resource2 = _a12.resource, id2 = _a12.id, data2 = _a12.data;
    var now = Date.now();
    ...
    var updateColl = function(old) {
      ...
      return __spreadArray17(__spreadArray17(__spreadArray17([], old.slice(0, index), true), [
        __assign43(__assign43({}, old[index]), data2)
      ], false), old.slice(index + 1), true);
    };
    queryClient.setQueryData([resource2, "getOne", { id: String(id2), meta }], function(record) {
      return __assign43(__assign43({}, record), data2);
    }, { updatedAt });
    queryClient.setQueriesData({ queryKey: [resource2, "getList"] }, function(res) {
      return res && res.data ? __assign43(__assign43({}, res), { data: updateColl(res.data) }) : res;
    }, { updatedAt });
    queryClient.setQueriesData({ queryKey: [resource2, "getInfiniteList"] }, function(res) {
      return res && res.pages ? __assign43(__assign43({}, res), { pages: res.pages.map(function(page) {
        return __assign43(__assign43({}, page), { data: updateColl(page.data) });
      }) }) : res;
    }, { updatedAt });
  ...
  var mutation = useMutation(__assign43(__assign43({ mutationFn: function(_a12) {
      ...
      return __generator10(this, function(_a12) {
        switch (_a12.label) {
          ...
          case 1:
            ...
            return [2, __assign43({ snapshot: snapshot.current }, userContext)];
          case 2:
      ...
      return __generator10(this, function(_e) {
        switch (_e.label) {
          case 0:
            ...
            if (mode.current === "pessimistic") {
              if (returnPromise) {
                return [2, mutation.mutateAsync(__assign43({ resource: callTimeResource }, callTimeParams), __assign43({ onSuccess }, otherCallTimeOptions))];
              }
              return [2, mutation.mutate(__assign43({ resource: callTimeResource }, callTimeParams), __assign43({ onSuccess }, otherCallTimeOptions))];
            }
          ...
          case 1:
            ...
            setTimeout(function() {
              if (onSuccess) {
                onSuccess(__assign43(__assign43({}, previousRecord), callTimeData), __assign43({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              } else if (mutationOptions.onSuccess && !hasCallTimeOnSuccess.current) {
                mutationOptions.onSuccess(__assign43(__assign43({}, previousRecord), callTimeData), __assign43({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }
            }, 0);
            if (mode.current === "optimistic") {
              return [2, mutation.mutate(__assign43({ resource: callTimeResource }, callTimeParams))];
            } else {
              undoableEventEmitter_default.once("end", function(_a13) {
                ...
                if (isUndo) {
                  ...
                  mutation.mutate(__assign43({ resource: callTimeResource }, callTimeParams));
                }
              });
            }
            return [
  ...
  var mutationResult = (0, import_react108.useMemo)(function() {
    return __assign43({ isLoading: mutation.isPending }, mutation);
  }, [mutation]);
...
var useUpdateMany = function(resource, params, options) {
  ...
  var _a11 = options.mutationMode, mutationMode = _a11 === void 0 ? "pessimistic" : _a11, mutationOptions = __rest37(options, ["mutationMode"]);
  var mode = (0, import_react109.useRef)(mutationMode);
  var paramsRef = (0, import_react109.useRef)(params);
  var snapshot = (0, import_react109.useRef)([]);
  var hasCallTimeOnError = (0, import_react109.useRef)(false);
  var hasCallTimeOnSuccess = (0, import_react109.useRef)(false);
  var hasCallTimeOnSettled = (0, import_react109.useRef)(false);
  var updateCache = function(_a12) {
    ...
    return __awaiter11(void 0, void 0, void 0, function() {
      ...
      return __generator11(this, function(_b) {
        ...
        updateColl = function(old) {
          if (!old)
            return old;
          var newCollection = __spreadArray18([], old, true);
          ids2.forEach(function(id) {
            ...
            newCollection = __spreadArray18(__spreadArray18(__spreadArray18([], newCollection.slice(0, index), true), [
              __assign44(__assign44({}, newCollection[index]), data2)
        ...
        ids2.forEach(function(id) {
          queryClient.setQueryData([resource2, "getOne", { id: String(id), meta: meta2 }], function(record) {
            return __assign44(__assign44({}, record), data2);
          }, { updatedAt });
        });
        queryClient.setQueriesData({ queryKey: [resource2, "getList"] }, function(res) {
          return res && res.data ? __assign44(__assign44({}, res), { data: updateColl(res.data) }) : res;
        }, { updatedAt });
        queryClient.setQueriesData({ queryKey: [resource2, "getInfiniteList"] }, function(res) {
          return res && res.pages ? __assign44(__assign44({}, res), { pages: res.pages.map(function(page) {
            return __assign44(__assign44({}, page), { data: updateColl(page.data) });
          }) }) : res;
        }, { updatedAt });
        queryClient.setQueriesData({ queryKey: [resource2, "getMany"] }, function(coll) {
          return coll && coll.length > 0 ? updateColl(coll) : coll;
  ...
  var mutation = useMutation(__assign44(__assign44({ mutationFn: function(_a12) {
    ...
    return __awaiter11(void 0, void 0, void 0, function() {
      var userContext;
      return __generator11(this, function(_a12) {
        switch (_a12.label) {
          case 0:
            if (!mutationOptions.onMutate)
              return [3, 2];
          ...
          case 1:
            userContext = _a12.sent() || {};
            return [2, __assign44({ snapshot: snapshot.current }, userContext)];
          case 2:
            return [2, { snapshot: snapshot.current }];
        }
      });
      ...
      return __generator11(this, function(_e) {
        switch (_e.label) {
          case 0:
            ...
            mutationMode2 = callTimeOptions.mutationMode, _a12 = callTimeOptions.returnPromise, returnPromise = _a12 === void 0 ? mutationOptions.returnPromise : _a12, otherCallTimeOptions = __rest37(callTimeOptions, ["mutationMode", "returnPromise"]);
            hasCallTimeOnError.current = !!otherCallTimeOptions.onError;
            hasCallTimeOnSuccess.current = !!otherCallTimeOptions.onSuccess;
            hasCallTimeOnSettled.current = !!otherCallTimeOptions.onSettled;
            paramsRef.current = params;
            ...
            if (mode.current === "pessimistic") {
              if (returnPromise) {
                return [2, mutation.mutateAsync(__assign44({ resource: callTimeResource }, callTimeParams), otherCallTimeOptions)];
              }
              return [2, mutation.mutate(__assign44({ resource: callTimeResource }, callTimeParams), otherCallTimeOptions)];
            }
          ...
          case 2:
            ...
            setTimeout(function() {
              if (otherCallTimeOptions.onSuccess) {
                otherCallTimeOptions.onSuccess(callTimeIds, __assign44({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              } else if (mutationOptions.onSuccess) {
                mutationOptions.onSuccess(callTimeIds, __assign44({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }
            }, 0);
            if (mode.current === "optimistic") {
              return [2, mutation.mutate(__assign44({ resource: callTimeResource }, callTimeParams), {
              ...
              undoableEventEmitter_default.once("end", function(_a13) {
                ...
                if (isUndo) {
                  ...
                  mutation.mutate(__assign44({ resource: callTimeResource }, callTimeParams), {
                    onSettled: otherCallTimeOptions.onSettled,
                    onError: otherCallTimeOptions.onError
                  });
                }
  ...
  var mutationResult = (0, import_react109.useMemo)(function() {
    return __assign44({ isLoading: mutation.isPending }, mutation);
  }, [mutation]);
...
var useDelete = function(resource, params, options) {
  ...
  var _a11 = options.mutationMode, mutationMode = _a11 === void 0 ? "pessimistic" : _a11, mutationOptions = __rest38(options, ["mutationMode"]);
  var mode = (0, import_react110.useRef)(mutationMode);
  var paramsRef = (0, import_react110.useRef)(params);
  var snapshot = (0, import_react110.useRef)([]);
  var hasCallTimeOnError = (0, import_react110.useRef)(false);
  var hasCallTimeOnSuccess = (0, import_react110.useRef)(false);
  var hasCallTimeOnSettled = (0, import_react110.useRef)(false);
  var updateCache = function(_a12) {
    ...
    var updateColl = function(old) {
      ...
      return __spreadArray19(__spreadArray19([], old.slice(0, index), true), old.slice(index + 1), true);
    };
    queryClient.setQueriesData({ queryKey: [resource2, "getList"] }, function(res) {
      if (!res || !res.data)
        return res;
    ...
    queryClient.setQueriesData({ queryKey: [resource2, "getInfiniteList"] }, function(res) {
      if (!res || !res.pages)
        return res;
      return __assign45(__assign45({}, res), { pages: res.pages.map(function(page) {
        var newCollection = updateColl(page.data);
        var recordWasFound = newCollection.length < page.data.length;
        return recordWasFound ? __assign45(__assign45({}, page), { data: newCollection, total: page.total ? page.total - 1 : void 0, pageInfo: page.pageInfo }) : page;
      }) });
    }, { updatedAt });
    queryClient.setQueriesData({ queryKey: [resource2, "getMany"] }, function(coll) {
      return coll && coll.length > 0 ? updateColl(coll) : coll;
  ...
  var mutation = useMutation(__assign45(__assign45({ mutationFn: function(_a12) {
    ...
    return __awaiter12(void 0, void 0, void 0, function() {
      var userContext;
      return __generator12(this, function(_a12) {
        switch (_a12.label) {
          case 0:
            if (!mutationOptions.onMutate)
              return [3, 2];
          ...
          case 1:
            userContext = _a12.sent() || {};
            return [2, __assign45({ snapshot: snapshot.current }, userContext)];
          case 2:
            return [2, { snapshot: snapshot.current }];
        }
      });
  ...
  var mutate = function(callTimeResource, callTimeParams, callTimeOptions) {
    ...
    return __awaiter12(void 0, void 0, void 0, function() {
      ...
      return __generator12(this, function(_c) {
        switch (_c.label) {
          case 0:
            mutationMode2 = callTimeOptions.mutationMode, otherCallTimeOptions = __rest38(callTimeOptions, ["mutationMode"]);
            ...
            if (mode.current === "pessimistic") {
              return [2, mutation.mutate(__assign45({ resource: callTimeResource }, callTimeParams), otherCallTimeOptions)];
            }
          ...
          case 1:
            ...
            setTimeout(function() {
              if (callTimeOptions.onSuccess) {
                callTimeOptions.onSuccess(callTimePreviousData, __assign45({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              } else if (mutationOptions.onSuccess) {
                mutationOptions.onSuccess(callTimePreviousData, __assign45({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }
            }, 0);
            if (mode.current === "optimistic") {
              return [2, mutation.mutate(__assign45({ resource: callTimeResource }, callTimeParams), {
              ...
              undoableEventEmitter_default.once("end", function(_a13) {
                ...
                if (isUndo) {
                  ...
                  mutation.mutate(__assign45({ resource: callTimeResource }, callTimeParams), {
                    onSettled: callTimeOptions.onSettled,
                    onError: callTimeOptions.onError
                  });
                }
  ...
  var mutationResult = (0, import_react110.useMemo)(function() {
    return __assign45({ isLoading: mutation.isPending }, mutation);
  }, [mutation]);
...
var useDeleteMany = function(resource, params, options) {
  ...
  var queryClient = useQueryClient();
  var ids = params.ids;
  var _a11 = options.mutationMode, mutationMode = _a11 === void 0 ? "pessimistic" : _a11, mutationOptions = __rest39(options, ["mutationMode"]);
  var mode = (0, import_react111.useRef)(mutationMode);
  var paramsRef = (0, import_react111.useRef)({});
  var snapshot = (0, import_react111.useRef)([]);
  var hasCallTimeOnError = (0, import_react111.useRef)(false);
  var hasCallTimeOnSuccess = (0, import_react111.useRef)(false);
  var hasCallTimeOnSettled = (0, import_react111.useRef)(false);
  var updateCache = function(_a12) {
    ...
    var updateColl = function(old) {
      if (!old)
        return old;
      var newCollection = __spreadArray20([], old, true);
      ids2.forEach(function(id) {
        ...
        newCollection = __spreadArray20(__spreadArray20([], newCollection.slice(0, index), true), newCollection.slice(index + 1), true);
      });
      return newCollection;
    };
    queryClient.setQueriesData({ queryKey: [resource2, "getList"] }, function(res) {
    ...
    queryClient.setQueriesData({ queryKey: [resource2, "getInfiniteList"] }, function(res) {
      if (!res || !res.pages)
        return res;
      return __assign46(__assign46({}, res), { pages: res.pages.map(function(page) {
        var newCollection = updateColl(page.data);
        var recordWasFound = newCollection.length < page.data.length;
        return recordWasFound ? __assign46(__assign46({}, page), { data: newCollection, total: page.total ? page.total - (page.data.length - newCollection.length) : void 0, pageInfo: page.pageInfo }) : page;
      }) });
    }, { updatedAt });
    queryClient.setQueriesData({ queryKey: [resource2, "getMany"] }, function(coll) {
      return coll && coll.length > 0 ? updateColl(coll) : coll;
  ...
  var mutation = useMutation(__assign46(__assign46({ mutationFn: function(_a12) {
    ...
    return __awaiter13(void 0, void 0, void 0, function() {
      var userContext;
      return __generator13(this, function(_a12) {
        switch (_a12.label) {
          case 0:
            if (!mutationOptions.onMutate)
              return [3, 2];
          ...
          case 1:
            userContext = _a12.sent() || {};
            return [2, __assign46({ snapshot: snapshot.current }, userContext)];
          case 2:
            return [2, { snapshot: snapshot.current }];
        }
      });
  ...
  var mutate = function(callTimeResource, callTimeParams, callTimeOptions) {
    ...
    return __awaiter13(void 0, void 0, void 0, function() {
      ...
      return __generator13(this, function(_b) {
        switch (_b.label) {
          case 0:
            mutationMode2 = callTimeOptions.mutationMode, otherCallTimeOptions = __rest39(callTimeOptions, ["mutationMode"]);
            hasCallTimeOnError.current = !!callTimeOptions.onError;
            hasCallTimeOnSuccess.current = !!callTimeOptions.onSuccess;
            hasCallTimeOnSettled.current = !!callTimeOptions.onSettled;
            paramsRef.current = params;
            ...
            if (mode.current === "pessimistic") {
              return [2, mutation.mutate(__assign46({ resource: callTimeResource }, callTimeParams), {
          ...
          case 1:
            ...
            setTimeout(function() {
              if (otherCallTimeOptions.onSuccess) {
                otherCallTimeOptions.onSuccess(callTimeIds, __assign46({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              } else if (mutationOptions.onSuccess) {
                mutationOptions.onSuccess(callTimeIds, __assign46({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }
            }, 0);
            if (mode.current === "optimistic") {
              return [2, mutation.mutate(__assign46({ resource: callTimeResource }, callTimeParams), {
              ...
              undoableEventEmitter_default.once("end", function(_a13) {
                ...
                if (isUndo) {
                  ...
                  mutation.mutate(__assign46({ resource: callTimeResource }, callTimeParams), {
                    onSettled: otherCallTimeOptions.onSettled,
                    onError: otherCallTimeOptions.onError
                  });
                }
  ...
  var mutationResult = (0, import_react111.useMemo)(function() {
    return __assign46({ isLoading: mutation.isPending }, mutation);
  }, [mutation]);
  return [useEvent(mutate), mutationResult];
};
...
var useInfiniteGetList = function(resource, params, options) {
  ...
  var dataProvider = useDataProvider();
  var queryClient = useQueryClient();
  var _g = options.onSuccess, onSuccess = _g === void 0 ? noop8 : _g, _h = options.onError, onError = _h === void 0 ? noop8 : _h, _j = options.onSettled, onSettled = _j === void 0 ? noop8 : _j, queryOptions2 = __rest40(options, ["onSuccess", "onError", "onSettled"]);
  var onSuccessEvent = useEvent(onSuccess);
  var onErrorEvent = useEvent(onError);
  var onSettledEvent = useEvent(onSettled);
  var result = useInfiniteQuery(__assign47(__assign47({ queryKey: [
    resource,
    "getInfiniteList",
    ...
    return dataProvider.getList(resource, {
      ...
      var data = _a13.data, pageInfo = _a13.pageInfo, total = _a13.total;
      return {
        data,
        total,
        pageParam,
  ...
  var metaValue = (0, import_react112.useRef)(meta);
  var resourceValue = (0, import_react112.useRef)(resource);
  ...
  return result.data ? __assign47(__assign47({}, result), { data: result.data, total: (_c = (_b = (_a11 = result.data) === null || _a11 === void 0 ? void 0 : _a11.pages[0]) === null || _b === void 0 ? void 0 : _b.total) !== null && _c !== void 0 ? _c : void 0 }) : result;
};
var noop8 = function() {
  return void 0;
};
...
var PreferencesEditorContext = (0, import_react113.createContext)(void 0);

// node_modules/ra-core/dist/esm/preferences/PreferencesEditorContextProvider.js
var PreferencesEditorContextProvider = function(_a11) {
  var children = _a11.children;
  var _b = (0, import_react114.useState)(false), isEnabled = _b[0], setIsEnabled = _b[1];
  var _c = (0, import_react114.useState)(null), editor = _c[0], setEditor = _c[1];
  var _d = (0, import_react114.useState)(null), preferenceKey = _d[0], setPreferenceKey = _d[1];
  var _e = (0, import_react114.useState)(null), path = _e[0], setPath = _e[1];
  var _f = (0, import_react114.useState)(null), title = _f[0], setTitleString = _f[1];
  var _g = (0, import_react114.useState)(), titleOptions = _g[0], setTitleOptions = _g[1];
  var enable = (0, import_react114.useCallback)(function() {
    return setIsEnabled(true);
  }, []);
  var disable = (0, import_react114.useCallback)(function() {
    setIsEnabled(false);
    setEditor(null);
  }, []);
  var setTitle = (0, import_react114.useCallback)(function(title2, titleOptions2) {
    setTitleString(title2);
    setTitleOptions(titleOptions2);
  }, []);
  var context = (0, import_react114.useMemo)(function() {
    return {
      editor,
      setEditor,
      preferenceKey,
  ...
  return React46.createElement(PreferencesEditorContext.Provider, { value: context }, children);
};
...
var ResourceDefinitionContext = (0, import_react115.createContext)({
  definitions: {},
  register: function() {
  },
  unregister: function() {
...
var ResourceDefinitionContextProvider = function(_a11) {
  ...
  var _c = (0, import_react115.useState)(defaultDefinitions), definitions = _c[0], setState = _c[1];
  var register = (0, import_react115.useCallback)(function(config) {
    setState(function(prev) {
      var _a12;
      return (0, import_isEqual6.default)(prev[config.name], config) ? prev : __assign48(__assign48({}, prev), (_a12 = {}, _a12[config.name] = config, _a12));
    });
  }, []);
  var unregister = (0, import_react115.useCallback)(function(config) {
    setState(function(prev) {
      var _a12 = prev, _b2 = config.name, _ = _a12[_b2], rest = __rest41(_a12, [typeof _b2 === "symbol" ? _b2 : _b2 + ""]);
      return rest;
    });
  }, []);
  var contextValue = (0, import_react115.useMemo)(
    function() {
  ...
  return React47.createElement(ResourceDefinitionContext.Provider, { value: contextValue }, children);
};
...
var CoreAdminContext = function(props) {
  ...
  var finalQueryClient = (0, import_react116.useMemo)(function() {
    return queryClient || new QueryClient();
  }, [queryClient]);
  var finalAuthProvider = (0, import_react116.useMemo)(function() {
    return authProvider instanceof Function ? convertLegacyAuthProvider_default(authProvider) : authProvider;
  }, [authProvider]);
  var finalDataProvider = (0, import_react116.useMemo)(function() {
            ...
            React48.createElement(
              ...
              React48.createElement(
                ...
                React48.createElement(
                  ...
                  null,
                  React48.createElement(ResourceDefinitionContextProvider, null, children)
                )
              )
            )
          )
...
var ErrorBoundaryContext = (0, import_react117.createContext)(null);
var initialState = {
  didCatch: false,
  error: null
};
var ErrorBoundary = class extends import_react117.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    if (didCatch) {
      ...
      if (typeof fallbackRender === "function") {
        ...
        childToRender = (0, import_react117.createElement)(FallbackComponent, props);
      } else if (fallback === null || (0, import_react117.isValidElement)(fallback)) {
    ...
    return (0, import_react117.createElement)(ErrorBoundaryContext.Provider, {
      value: {
        didCatch,
        error,
        resetErrorBoundary: this.resetErrorBoundary
...
var useRoutesAndResourcesState = function(initialState2) {
  var _a11 = (0, import_react119.useState)(initialState2), routesAndResources = _a11[0], setRoutesAndResources = _a11[1];
...
var getRoutesAndResourceFromNodes = function(children) {
  ...
  import_react119.Children.forEach(children, function(element) {
    if (!React49.isValidElement(element)) {
      return;
    }
...
var CoreAdminRoutes = function(props) {
  ...
  if (status === "empty") {
    ...
    return React50.createElement(Ready, null);
  }
  if (status === "loading" || checkAuthLoading) {
    return React50.createElement(
      ...
      null,
      customRoutesWithoutLayout,
      React50.createElement(Route, { path: "*", element: React50.createElement(
        "div",
        { style: { height: "100vh" } },
        React50.createElement(LoadingPage, null)
      ) })
    );
  }
  if (onlyAnonymousRoutes) {
    return React50.createElement(
      ...
      null,
      customRoutesWithoutLayout,
      React50.createElement(Route, { path: "*", element: React50.createElement(LogoutOnMount, null) })
    );
  }
  return React50.createElement(
    Routes,
      ...
      React50.createElement(
        ...
        React50.createElement(
          ...
          import_react121.Children.map(resources, function(resource) {
            return React50.createElement(Route, { key: resource.props.name, path: "".concat(resource.props.name, "/*"), element: resource });
          }),
          React50.createElement(Route, { path: "/", element: dashboard ? React50.createElement(WithPermissions_default, { authParams: defaultAuthParams2, component: dashboard }) : resources.length > 0 ? React50.createElement(Navigate, { to: createPath({
            resource: resources[0].props.name,
            type: "list"
          }) }) : null }),
          React50.createElement(Route, { path: "*", element: React50.createElement(CatchAll, null) })
        )
      )
    ) })
  );
...
var DefaultError = function(_a11) {
  ...
  return React51.createElement(
    "div",
    null,
    React51.createElement("h1", null, "Error"),
...
var CoreAdminUI = function(props) {
  var _a11 = (0, import_react123.useState)({}), errorInfo = _a11[0], setErrorInfo = _a11[1];
    ...
    React51.createElement(
      ...
      { onError: handleError, fallbackRender: function(_a12) {
        ...
        return React51.createElement(
          ...
          React51.createElement(ErrorComponent, { error, errorInfo, resetErrorBoundary })
        );
      } },
      React51.createElement(
        Routes,
        null,
        LoginPage !== false && LoginPage !== true ? React51.createElement(Route, { path: "/login", element: createOrGetElement(LoginPage) }) : null,
        LoginCallbackPage !== false && LoginCallbackPage !== true ? React51.createElement(Route, { path: "/auth-callback", element: createOrGetElement(LoginCallbackPage) }) : null,
        React51.createElement(Route, { path: "/*", element: React51.createElement(CoreAdminRoutes, { catchAll, dashboard, layout, loading, requireAuth, ready }, children) })
      )
    )
  );
};
...
var CoreAdmin = function(props) {
  ...
  return React52.createElement(
    ...
    React52.createElement(CoreAdminUI, { layout, dashboard, disableTelemetry, catchAll, title, loading, error, loginPage, requireAuth, ready }, children)
  );
};
...
var ResourceContextProvider = function(_a11) {
  var children = _a11.children, value = _a11.value;
  return value ? React53.createElement(ResourceContext.Provider, { value }, children) : children;
};

// node_modules/ra-core/dist/esm/core/OptionalResourceContextProvider.js
var OptionalResourceContextProvider = function(_a11) {
  var value = _a11.value, children = _a11.children;
  return value ? React54.createElement(ResourceContextProvider, { value }, children) : children;
};
...
var Resource = function(props) {
  ...
  return React55.createElement(
    ...
    React55.createElement(
      Routes,
      null,
      create && React55.createElement(Route, { path: "create/*", element: getElement(create) }),
      show && React55.createElement(Route, { path: ":id/show/*", element: getElement(show) }),
      edit && React55.createElement(Route, { path: ":id/*", element: getElement(edit) }),
      list && React55.createElement(Route, { path: "/*", element: React55.createElement(RestoreScrollPosition, { storeKey: "".concat(name, ".list.scrollPosition") }, getElement(list)) }),
      props.children
    )
  );
};
var getElement = function(ElementOrComponent) {
  ...
  if ((0, import_react_is.isValidElementType)(ElementOrComponent)) {
    ...
    return React55.createElement(Element_1, null);
  }
  return null;
};
...
var SourceContext = (0, import_react126.createContext)({
  getSource: function(source) {
    return source;
  },
  getLabel: function(source) {
...
var useGetRecordRepresentation = function(resource) {
  ...
  return (0, import_react129.useCallback)(function(record) {
    ...
    if (React56.isValidElement(recordRepresentation)) {
...
var useTranslateLabel = function() {
  ...
  return (0, import_react130.useCallback)(function(_a11) {
...
var FieldTitle = function(props) {
  ...
  return React57.createElement(
    ...
    isRequired3 && React57.createElement("span", { "aria-hidden": "true" }, " *")
  );
};
...
var useLayoutEffect2 = typeof window !== "undefined" ? React59.useLayoutEffect : React59.useEffect;
var useEvent = function(fn) {
  var ref = React59.useRef(function() {
...
var getHashForUrl = function(url, fetchOptions) {
  return __awaiter15(void 0, void 0, void 0, function() {
    ...
    return __generator15(this, function(_a11) {
      switch (_a11.label) {
        case 0:
...
var useAuthState = function(params, logoutOnFailure, queryOptions2) {
  ...
  var basename = useBasename();
  var notify = useNotify();
  var onSuccess = queryOptions2.onSuccess, onError = queryOptions2.onError, onSettled = queryOptions2.onSettled, options = __rest42(queryOptions2, ["onSuccess", "onError", "onSettled"]);
  var result = useQuery(__assign52({ queryKey: ["auth", "checkAuth", params], queryFn: function(_a11) {
  ...
  return (0, import_react140.useMemo)(function() {
    ...
    return __assign52(__assign52({}, result), {
      ...
      authenticated: ((_a11 = result.data) !== null && _a11 !== void 0 ? _a11 : result.isLoading) ? true : authProvider == null
    });
  }, [authProvider, result]);
};
...
var usePermissions = function(params, queryParams) {
  ...
  var authProvider = useAuthProvider_default();
  var logoutIfAccessDenied = useLogoutIfAccessDenied_default();
  var _a11 = queryParams !== null && queryParams !== void 0 ? queryParams : {}, onSuccess = _a11.onSuccess, onError = _a11.onError, onSettled = _a11.onSettled, queryOptions2 = __rest43(_a11, ["onSuccess", "onError", "onSettled"]);
  var result = useQuery(__assign53({ queryKey: ["auth", "getPermissions", params], queryFn: function(_a12) {
    var signal = _a12.signal;
    return __awaiter16(void 0, void 0, void 0, function() {
      var permissions;
      return __generator16(this, function(_b) {
        switch (_b.label) {
          case 0:
            if (!authProvider)
  ...
  var onSuccessEvent = useEvent(onSuccess !== null && onSuccess !== void 0 ? onSuccess : noop10);
...
var useAuthenticated = function(_a11) {
  ...
  var params = _a11.params, options = __rest44(_a11, ["params"]);
...
var Authenticated = function(props) {
  var authParams = props.authParams, children = props.children, _a11 = props.requireAuth, requireAuth = _a11 === void 0 ? false : _a11;
  ...
  return React60.createElement(React60.Fragment, null, children);
};
...
var useGetIdentity = function(options) {
  ...
  var authProvider = useAuthProvider_default();
  var onSuccess = options.onSuccess, onError = options.onError, onSettled = options.onSettled, queryOptions2 = __rest46(options, ["onSuccess", "onError", "onSettled"]);
  var result = useQuery(__assign55({ queryKey: ["auth", "getIdentity"], queryFn: function(_a11) {
    var signal = _a11.signal;
...
var useHandleAuthCallback = function(options) {
  ...
  var _a11 = options !== null && options !== void 0 ? options : {}, onSuccess = _a11.onSuccess, onError = _a11.onError, onSettled = _a11.onSettled, queryOptions2 = __rest47(_a11, ["onSuccess", "onError", "onSettled"]);
  var queryResult = useQuery(__assign56({ queryKey: ["auth", "handleCallback"], queryFn: function(_a12) {
    var signal = _a12.signal;
      ...
      if (shouldIntercept) {
        return function() {
          ...
          return __awaiter18(_this, void 0, void 0, function() {
            return __generator18(this, function(_a11) {
              switch (_a11.label) {
                case 0:
...
var PreferenceKeyContextProvider = function(_a11) {
  ...
  return React61.createElement(PreferenceKeyContext.Provider, { value }, children);
};
...
var DefaultComponent = function() {
  return React62.createElement("span", null, ";");
};
var defaultType = {
...
inflection/lib/inflection.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-SY46ZYPV.js.map
